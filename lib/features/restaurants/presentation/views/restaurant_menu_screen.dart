...
class _RestaurantMenuScreenState extends ConsumerState<RestaurantMenuScreen> {
  ...
  List<Map<String, dynamic>> get _filteredReviews {
    ...
    return _mockReviews
        .where(
          (r) =>
              (r['rating'] as double) >= rating &&
              (r['rating'] as double) < rating + 1.0,
        )
        .toList();
  }
                      ...
                      children: ["All", "5.0", "4.0", "3.0", "2.0"].map((
                        ...
                        return Padding(
                          ...
                          child: FilterChip(
                            ...
                            selected: isSelected,
                            onSelected: (val) =>
                                setState(() => _selectedReviewFilter = filter),
                            backgroundColor: colorScheme.surface,
            ...
            child: Row(
              children: [
                ...
                Card(
                  elevation: 0,
                  child: Hero(
                    tag: "res_${item.name}_${widget.index}",
                    child: ClipRRect(
